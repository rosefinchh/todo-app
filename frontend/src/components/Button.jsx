...
export function SubmitButton({ onClick, buttonName }) {
  return (
    <button
      type="button"
      className="text-white bg-gray-600 hover:bg-gray-800 active:bg-gray-700 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2"
      onClick={onClick}
    >
      {buttonName}
    </button>
